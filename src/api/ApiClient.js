...
class ApiClient {
  constructor() {
     ...
     * @type {String}
     * @default https://api-ng.citypizza.ru/v2
     */
    this.basePath = 'https://testapi.citypizza.ru/v2'.replace(/\/+$/, '');
    // this.basePath = 'https://api-ng.citypizza.ru/v2'.replace(/\/+$/, '');
  ...
  hostSettings() {
    return [
      {
        url: 'https://api-ng.citypizza.ru/v2/',
